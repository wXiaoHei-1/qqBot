...
// Websocket_clt Client websocket 连接客户端
...
// SendMessage 发送数据
func (c *Websocket_clt) SendMessage(message *types.WSPayload) error {
...
func (c *Websocket_clt) isHandleBuildIn(payload *types.WSPayload) bool {
...
func (c *Websocket_clt) readyHandler(payload *types.WSPayload) {
